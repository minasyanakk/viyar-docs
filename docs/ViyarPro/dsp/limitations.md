...
>
   ...
   3. <b>Для поклейки кромкой с толщиной 0,4 - 0,6 мм (включительно):</b>
  - Минимально допустимый размер детали – 30x150 мм
  - Минимальный R-10
  - Г-образный зарез – 20x20 мм
   4. <b>Для поклейки кромкой с толщиной 0,8 мм:</b>
  - Минимально допустимый размер детали – 30x150 мм
  - Минимальный R-30
   5. <b>Для поклейки кромкой с толщиной от 1 мм:</b>
  - Минимально допустимый размер детали – 50x150 мм
  - Минимальный R-70 мм (для толщины детали до 31 мм)
  - Минимальный R-80 мм (для толщины детали от 32 мм)
  - Минимальный размер Г-образного зареза 50x50 мм
   6. <b>Поклейка кромки для закрывания паза:</b>
  - Ширина паза больше 7 мм
  
>__Кромкование ручное (вырезы/окна)__
>
   1. <b>Для поклейки кромкой c толщиной до 0,6 мм (включительно):</b>
>   Минимальные размеры П-образного выреза:
  - 30х10 с максимальной глубиной 50 мм
  - 50х10 с максимальной глубиной 200 мм
  - 100х10 мм с максимальной глубиной 400 мм
  - 300х10 мм с глубиной более 400 мм
   2. <b>Для поклейки кромкой с толщиной до 0,6 мм (включительно):</b>
  - Минимальный R-10 мм
  - Минимальный размер П-образного выреза – 100x10 мм
  - Минимальный размер выреза окна 150x150 мм 
  - Минимальный рамер окружности R-100 мм
   3. b>Для поклейки кромкой с толщиной 0,8 мм (включительно):</b>
  - Минимальный R-20 мм
  - Минимальный размер П-образного выреза – 200x10 мм с максимальной глубиной до 400 мм или 300х10 с глубиной более 400 мм
